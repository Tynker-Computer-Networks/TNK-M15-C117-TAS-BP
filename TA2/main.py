...
# Define a class named RemoteMouse that inherits from the App class.
class RemoteMouse(App):
    # Define the build method, which is a required method in Kivy applications.
    def build(self):
        # Declare 'sm' as a global variable to make it accessible outside this function.
        global sm
        
        # Create a ScreenManager instance named 'sm'.
        sm =  ScreenManager()
        
        # Add the FirstWindow instance to the ScreenManager with the name 'first'.
        sm.add_widget(FirstWindow(name='first'))
        
        # Add the SecondWindow instance to the ScreenManager with the name 'second'.
        sm.add_widget(SecondWindow(name='second'))
        
        # Return the 'sm' (ScreenManager) as the root widget for the Kivy application.
        return sm
